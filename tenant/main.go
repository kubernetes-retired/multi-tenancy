...
import (
	...
	"github.com/kubernetes-sigs/multi-tenancy/tenant/controllers"
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:   "9dbad61d.x-k8s.io",
	})
	if err != nil {
	...
	if err = (&tenancyv1alpha1.Tenant{}).SetupWebhookWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to create webhook", "webhook", "Tenant")
		os.Exit(1)
	}
	if err = (&tenancyv1alpha1.TenantNamespace{}).SetupWebhookWithManager(mgr); err != nil {
