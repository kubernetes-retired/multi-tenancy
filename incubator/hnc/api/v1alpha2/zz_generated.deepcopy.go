...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ConditionAndAffectedNamespaces) DeepCopyInto(out *ConditionAndAffectedNamespaces) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ConditionAndAffectedNamespaces.
func (in *ConditionAndAffectedNamespaces) DeepCopy() *ConditionAndAffectedNamespaces {
	if in == nil {
		return nil
	}
	out := new(ConditionAndAffectedNamespaces)
	in.DeepCopyInto(out)
	return out
}
...
func (in *HNCConfigurationStatus) DeepCopyInto(out *HNCConfigurationStatus) {
	*out = *in
	...
	if in.NamespaceConditions != nil {
		...
		*out = make([]ConditionAndAffectedNamespaces, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
