...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CodeAndAffectedNamespaces) DeepCopyInto(out *CodeAndAffectedNamespaces) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CodeAndAffectedNamespaces.
func (in *CodeAndAffectedNamespaces) DeepCopy() *CodeAndAffectedNamespaces {
	if in == nil {
		return nil
	}
	out := new(CodeAndAffectedNamespaces)
	in.DeepCopyInto(out)
	return out
}
...
func (in *HNCConfigurationStatus) DeepCopyInto(out *HNCConfigurationStatus) {
	*out = *in
	...
	if in.NamespaceConditions != nil {
		...
		*out = make([]CodeAndAffectedNamespaces, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
