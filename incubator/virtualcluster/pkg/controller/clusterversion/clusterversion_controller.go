...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	// Uncomment watch a Deployment created by ClusterVersion - change this for objects you create
	err = c.Watch(&source.Kind{Type: &appsv1.Deployment{}}, &handler.EnqueueRequestForOwner{
		IsController: true,
		OwnerType:    &tenancyv1alpha1.ClusterVersion{},
	})
	if err != nil {
		return err
	}
...
func (r *ReconcileClusterVersion) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	...
	instance := &tenancyv1alpha1.ClusterVersion{}
