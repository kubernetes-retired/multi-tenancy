...
module sigs.k8s.io/multi-tenancy/incubator/virtualcluster/pkg/vn-agent/server/test
...
require (
	...
	sigs.k8s.io/multi-tenancy/incubator/virtualcluster v0.0.0
)
...
replace (
	...
	// virtual-cluster.
	sigs.k8s.io/multi-tenancy/incubator/virtualcluster => ../../../../
)
