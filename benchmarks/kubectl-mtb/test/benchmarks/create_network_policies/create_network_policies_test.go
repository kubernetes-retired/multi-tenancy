...
func TestBenchmark(t *testing.T) {
	...
	tests := []struct {
		...
		{
			testName:     "testWithoutRbacPrivileges",
			testFunction: testWithoutRbacPrivileges,
			preRun:       true,
			run:          false,
		},
		{
			testName:     "testWithRbacPrivileges",
			testFunction: testWithRbacPrivileges,
			preRun:       true,
			run:          true,
		},
	}
...
func testWithoutRbacPrivileges(t *testing.T) (preRun bool, run bool) {
...
func testWithRbacPrivileges(t *testing.T) (preRun bool, run bool) {
